...
@section('content')
            ...
            <div class="row mt-3">
                ...
                <div class="col s_cake_about shadow-sm ">
                    ...
                    <div class="d-flex justify-content-center pt-5">
                        <button class="btn btn-about rounded-circle ms-4" type="button"> <img src="{{asset('main/img/i-cake.png')}}"
                                                                                              width="45" height="45" alt="Торт"> </button>
                        <button class="btn btn-about rounded-circle ms-4" type="button"> <img src="{{asset('main/img/i-waffle.png')}}"
                                                                                              width="45" height="45" alt="Вафля"> </button>
                        <button class="btn btn-about rounded-circle ms-4" type="button"> <img src="{{asset('main/img/i-muffin.png')}}"
                                                                                              width="45" height="45" alt="Маффин"> </button>
                    </div>
    ...
    <section class="section_order">
        <div class="container-fluid ">
            <div class="row">
                <div class="bg-image">
                    <div class="d-flex text-center justify-content-center align-items-center h-100" style="flex-direction: column">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="d-flex justify-content-center pt-5 mb-5">
                        <button class="btn btn-products shadow-sm" type="button"> <img src="{{asset('main/img/i-cake.png')}}" width="30" height="30" class="me-2" alt="Торт"> Торты </button>
                        <button class="btn btn-products ms-4 shadow-sm" type="button"> <img src="{{asset('main/img/i-waffle.png')}}" width="30" height="30" class="me-2" alt="Вафля"> Вафли </button>
                        <button class="btn btn-products ms-4 shadow-sm" type="button"> <img src="{{asset('main/img/i-muffin.png')}}" width="30" height="30" class="me-2" alt="Кекс"> Кексы </button>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xl-4">
                    <div class="card card-product text-center pb-3 mb-3 shadow-sm">
                        <div class="card-body d-flex align-items-center justify-content-between" style="flex-direction: column">
                            ...
                            <p>1.8 кг</p>
                            <img src="{{asset('main/img/product-1.png')}}" class="card-img-bottom img-card" alt="продукция_торт1">
                ...
                <div class="col-xl-4">
                    <div class="card card-product text-center pb-3 mb-3 shadow-sm">
                        <div class="card-body d-flex align-items-center justify-content-between" style="flex-direction: column">
                            ...
                            <p>2.5 кг</p>
                            <img src="{{asset('main/img/product-2.png')}}" class="card-img-bottom img-card" alt="продукция_торт2">
                            <p class="card-desc mb-1">Нежное воздушное тесто со сливочной начинкой</p>
                ...
                <div class="col-xl-4">
                    <div class="card card-product text-center pb-3 mb-3 shadow-sm">
                        <div class="card-body d-flex align-items-center justify-content-between" style="flex-direction: column">
                            ...
                            <p>2.0 кг</p>
                            <img src="{{asset('main/img/product-3.png')}}" class="card-img-bottom img-card" alt="продукция_торт3">
                            <p class="card-desc mb-1">Нежное воздушное тесто со сливочной начинкой</p>
