    ...
    <div class="sidebar-scroll">
        <div class="user-account">
            ...
            <div class="dropdown">
                ...
                <a href="javascript:void(0);" class="dropdown-toggle user-name" data-toggle="dropdown"><strong>Администратор</strong></a>
                <ul class="dropdown-menu dropdown-menu-right account">
                    <li><a href="professors-profile.html"><i class="icon-user"></i>Профиль</a></li>
                    <li><a href="app-inbox.html"><i class="icon-envelope-open"></i>Сообщения</a></li>
                    <li><a href="javascript:void(0);"><i class="icon-settings"></i>Настройки</a></li>
                    <li class="divider"></li>
                    <li><a href="page-login.html"><i class="icon-power"></i>Выйти</a></li>
                </ul>
            </div>
            <hr>
        ...
        <ul class="nav nav-tabs">
            <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#admin">Админ</a></li>
            ...
            <div class="tab-pane active" id="admin">
                <nav class="sidebar-nav">
                    <ul class="main-menu metismenu">
                        ...
                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-picture"></i><span>Баннеры</span> </a>
                            <ul>
                        ...
                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-briefcase"></i><span>Продукция</span> </a>
                            <ul>
                                <li><a href="departments.html">All Departments</a></li>
                                <li><a href="add-departments.html">Add Departments</a></li>
                            </ul>
                        ...
                        <li><a href="javascript:void(0);" class="has-arrow"><i class="fa fa-users"></i><span>Пользователи</span> </a>
                            <ul>
                                <li><a href="departments.html">All Departments</a></li>
                                <li><a href="add-departments.html">Add Departments</a></li>
                            </ul>
                        ...
                        <li><a href="javascript:void(0);" class="has-arrow"><i class="fas fa-comment"></i><span>Комментарии</span> </a>
                            <ul>
                                <li><a href="departments.html">All Departments</a></li>
                                <li><a href="add-departments.html">Add Departments</a></li>
                            </ul>
                        ...
                        <li><a href="app-inbox.html"><i class="icon-settings"></i>Настройки</a></li>
