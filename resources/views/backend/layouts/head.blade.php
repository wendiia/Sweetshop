<title>Sweetshop Dashboard</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="{{asset('backend/assets/vendor/bootstrap/css/bootstrap.min.css')}}?v=<?=time()?>">
    ...
    <!-- MAIN CSS -->
    <link rel="stylesheet" href="{{asset('backend/assets/css/main.css')}}?v=<?=time()?>">
    <link rel="stylesheet" href="{{asset('backend/assets/css/color_skins.css')}}?v=<?=time()?>">
    <style>
