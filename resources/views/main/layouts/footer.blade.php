<footer>
    <div class="container-fluid">
        <div class="row pt-5">
            <div class="col-xl-3">
                <a class="navbar-brand" href="#">
                    <img src="{{asset('main/img/logo-white.png')}}" alt="Logo" >
                </a>
            </div>

            <div class="col-xl-3 d-flex  justify-content-center">
                <img src="{{asset('main/img/i-pointer.png')}}" width="30" height="30" class="mt-1 me-3" alt="Телефон">
                <div class="">
                    <h5 class="text-uppercase text-white">Наш адрес</h5>
            ...
            <div class="col-xl-3 d-flex  justify-content-center">
                <img src="{{asset('main/img/i-phone.png')}}" width="30" height="30" class="mt-1 me-3" alt="Телефон">
                <div class="">
            ...
            <div class="col-xl-3 d-flex  justify-content-center">
                <img src="{{asset('main/img/i-sms.png')}}" width="30" height="30" class="mt-1 me-3" alt="Телефон">
                <div class="">
        ...
        <div class="row">
            <div class="col-xl-6">
                <p class="text-white fs-5">Copyright © 2020 Blare. All Rights Reserved</p>
            </div>
