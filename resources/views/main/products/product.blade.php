                ...
                <nav
                    ...
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{route('categories.show', $product->category->slug)}}"> {{$product->category->title}}</a>
                        </li>
...
{{--                        <p class="fs-5 my-auto"><i class="fa-regular fa-comment" style="color: #b0b0b0;"></i> 2 </p>--}}
                    ...
                    <div class="d-flex">
                        ...
                        <button id="{{$product->id}}" class="btn-product-add btn shadow-sm px-5 fs-4" type="button"> В
                            корзину
                        </button>
                    </div>
