...
class SpecialIngredientController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'Особые ингредиенты';
    ...
    {
        $grid = new Grid(new SpecialIngredient());
    ...
    {
        $show = new Show(SpecialIngredient::findOrFail($id));
    ...
    {
        $form = new Form(new SpecialIngredient());
